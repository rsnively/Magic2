...
public class ControlPanelView extends View {
    ...
    protected void Render(Graphics2D g) {
        ...
        g.drawString("Player 2", GetRect().GetLeft(), GetRect().GetTop() + 140);
        g.drawString("========", GetRect().GetLeft(), GetRect().GetTop() + 160);
        g.drawString("P2 Life: " + Game.Get().GetPlayer2().GetLifeTotal(), GetRect().GetLeft(), GetRect().GetTop() + 180);
        g.drawString("P2 Cards in Hand: " + Game.Get().GetPlayer2().GetHand().size(), GetRect().GetLeft(), GetRect().GetTop() + 200);
        g.drawString("P2 Cards in Library: " + Game.Get().GetPlayer2().GetLibrary().size(), GetRect().GetLeft(), GetRect().GetTop() + 220);
    ...
    protected void Clicked(Click c) {
        if (!Game.Get().GetStack().HasEffects())
